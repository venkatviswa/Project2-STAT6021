...
Our team analyzed the following internal housing factors: bedrooms, bathrooms, sqft_living, floors, condition, grade, sqft_above, and sqft_basement to see what had the most significant influence on housing prices. 

In our final model we were able to narrow the focus of our study to just three predictor variables:

- The square footage of the home
- The construction grade and design of a home
- The condition of the home

Additionally the team analyzed and removed a number of outlier and high leverage data points that influenced the model. In conclusion our study's findings reveal that the three most influential variables on housing prices in King County, Washington are the square footage of the home, the construction grade of the home and the condition of the home. These findings are crucial for understanding the dynamics of the local housing market and can greatly assist in making informed decisions related to real estate.
...
Our predictor variable is price and we are going to analyze the previuously listed predictor variables to find what variables influence price.
